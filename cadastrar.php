...
<body background="star1.jpg" >
  ...
  <div class="login-wrap">
	<div class="login-html">
		...
		<input id="tab-2" type="radio" name="tab" class="sign-up" checked><label for="tab-2" class="tab">Cadastrar</label>
		...
		<div class="login-form">
			...
			<div class="sign-up-htm">
				...
				<div class="group">
					...
					<input id="pass" type="password" class="input" name="senha1" required autocomplete="off" minlength="8">
				</div>
				<div class="group">
					<label for="pass" class="label">Email</label>
					<input id="pass" type="email" name="email" class="input" required autocomplete="off" minlength="8"> 
				</div>
				<div class="group">
					<input type="submit" class="button" value="Cadastrar" >

				</div>
				<label for="tab-1">Já tem Conta?</label><div class="hr" style="margin: 10px;"></div>
			</div>
		</form>
